...
class bottleneck_block(nn.Module):
    def __init__(self, filters, projection_shortcut, strides, first_num_filters) -> None:
        ...
        self.conv1 = nn.Conv2d(in_filters, hidden_filters, kernel_size=1, stride=1, padding=0,bias=True)
        self.bn_relu2 = batch_norm_relu_layer(hidden_filters,eps=1e-5, momentum=0.1)
        self.conv2 = nn.Conv2d(hidden_filters, hidden_filters, kernel_size=3, stride=self.strides, padding=1,bias=True)
